...
<div class="page-content">
 ...
 <span style="color: #184d88;">Branches </span> |<span style="font-size: 14px; font-weight: 300;"> Information Letters</span></div>
...
if($u_type == "branch"){
$select = "SELECT * FROM b_letter WHERE status = 'Information' and branch_name = '$branch_name'";
$run = mysqli_query($conn,$select);	
}else{		
$select = "SELECT * FROM b_letter WHERE status = 'Information'";
$run = mysqli_query($conn,$select);			
}
