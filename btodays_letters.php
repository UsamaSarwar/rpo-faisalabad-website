...
if($u_type == "branch"){
$select = "SELECT * FROM main_letter WHERE dispatch_date = '$date' and status = 'Pending' and marked_to = '$branch_id'";
$run = mysqli_query($conn,$select);	
}else{		
$select = "SELECT * FROM main_letter WHERE dispatch_date = '$date' and status = 'Pending'";
$run = mysqli_query($conn,$select);			
}
...
<div class="dropdown dropdown-status classDropup ">
				...
				<div class="dropdown-menu">
					...
					<a class="dropdown-item" href="branch_dispatch.php?id=<?php  echo $data['id'];?>" id="not_suspend">Main Dispatch</a>
					<a class="dropdown-item" href="#" id="not_suspend">Mark as Info</a>
				</div></div>
