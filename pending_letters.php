...
<div class="page-content">
 ...
 <span style="color: #184d88;">Main</span> |<span style="font-size: 14px; font-weight: 300;">Pending Letters</span></div>
...
$selectd = "SELECT * FROM branch_mark WHERE diary_number = '$diary'";
...
$datam = mysqli_fetch_array($runm);
		...
		$pending = $datam['distric'];
			...
			?>			
                    ...
                    <td><?php echo $datab['branch_name'];?></td>
...
<div class="dropdown dropdown-status classDropup ">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="other_main_letter.php?id=<?php echo $data['id'];?>" id="not_suspend">Mark to Other</a>
					<a class="dropdown-item" href="delete_main_letter.php?id=<?php echo $data['id'];?>" id="not_suspend">Delete Letter</a>
				</div></div>
