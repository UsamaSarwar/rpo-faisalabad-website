...
<div class="page-content">
 ...
 <span style="color: #184d88;">Kachari </span> |<span style="font-size: 14px; font-weight: 300;"> Dispose Off Kachari</span></div>
...
$select = "SELECT * FROM kachehri WHERE status = 'Dispose off'";
