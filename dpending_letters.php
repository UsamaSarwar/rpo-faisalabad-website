...
<div class="page-content">
 ...
 <span style="color: #184d88;">District </span> |<span style="font-size: 14px; font-weight: 300;">Pending Letters</span></div>
...
$select = "SELECT * FROM branch_mark WHERE current_status = 'Pending' and marked_to = '$did'";
$run = mysqli_query($conn,$select);
while($data = mysqli_fetch_array($run)):
			
$diary_number = $data['diary_number'];
			
$selectm = "SELECT * FROM main_letter WHERE dairy_number = '$diary_number'";
...
$datam = mysqli_fetch_array($runm);
			...
			?>			
                    ...
                    <td><?php echo $datam['dispatch_date'];?></td>
                    <td><?php echo $data['dispatch_from'];?></td>
...
$select = "SELECT * FROM b_letter WHERE status = 'Pending' and marked_to = '$did'";
$run = mysqli_query($conn,$select);
while($data = mysqli_fetch_array($run)):
