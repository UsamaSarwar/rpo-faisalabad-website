...
<div class="page-content">
 ...
 <span style="color: #184d88;">District </span> |<span style="font-size: 14px; font-weight: 300;">Completed Letters</span></div>
...
$select = "SELECT * FROM branch_mark WHERE current_status = 'Completed'";
