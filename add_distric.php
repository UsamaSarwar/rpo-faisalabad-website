...
<head lang="en">
	...
	<title>Create New District Form</title>
	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<h5 class="m-t-lg with-border" style="margin-bottom: 20px; color: #184d88;"><i class="font-icon"> <img src="img/Icons/diary.svg" style="height: 20px; width: 20px; " alt=""></i> Add District <span style="font-size: 15px; color: #545454;">(All fields marked with <span style="color: red;">*</span> are required)</span></h5>
...
$insert = "INSERT INTO `distric`(`division_name`, `distric`, `remarks`) VALUES ('$division_name','$distric','$remarks')";
				...
				<div class="row" style="padding: 0px 20px;">
					<div class="col-lg-8">
						<fieldset class="form-group">
							<label class="form-label" id="course_title" for="exampleemail">Division Name<span style="color: red;">*</span></label>
							<input type="text" class="form-control" name="division_name" data-validation="[NOTEMPTY]" data-validation-message="Enter Division Name" id="division_name" placeholder="Enter Division Name">
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" id="distric_title" for="exampleInputPassword1">District<span style="color: red;">*</span></label>
							<input type="text"  class="form-control" placeholder="District" name="distric" data-validation="[NOTEMPTY]" data-validation-message="Enter Disttrict" id="distric"><br>
						</fieldset>
					</div>
				</div>				
