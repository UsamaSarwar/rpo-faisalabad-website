...
if($_POST){
	$diary_number = $_POST['diary_number'];
	$branch_dispatch_no = $_POST['branch_dispatch_no'];
	...
	if($current_status == "Information"){
		...
		$update = "UPDATE main_letter SET status = '$current_status' WHERE id  = '$main_id'";
...
$insert = "INSERT INTO `branch_mark`(`diary_number`, `branch_dispatch_no`, `dispatch_date`,`dispatch_from`, `marked_to`, `officer_name`, `due_date`, `current_status`, `remarks`, `file`) VALUES ('$diary_number','$branch_dispatch_no','$dispatch_date','$dispatch_from','".$_POST['marked_to'][$x]."','$officer_name','$due_date','$current_status','$remarks','$file')";
				...
				<div class="row" style="padding: 0px 20px;">
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInput">Diary # <span style="color: red;">*</span></label>
							<input type="text" class="form-control" name="diary_number" readonly  value="<?php echo $datam['dairy_number'];?>" data-validation="[NOTEMPTY]" data-validation-message="Enter Dairy Number" id="diary_number" placeholder="Enter Dairy Number">
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" id="course_title" for="exampleemail">Branch Name <span style="color: red;">*</span></label>
							<input type="text" class="form-control" readonly name="dispatch_from" value="<?php echo $datab['branch_name'];?>" id="b_name" placeholder="Enter Branch Name">
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
	       ...
	       <div class="row" style="padding: 0px 20px;">
			   ...
			   <div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text"  class="form-control"  data-validation="[NOTEMPTY]" data-validation-message="Enter Branch Dispatch No"  name="branch_dispatch_no" id="branch_dispatch_no"><br>
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
...
//		  var b_number = $("#b_name").val();
//		  $.ajax({
//			  url: "disnum.php",
//			  type: "POST",
//			  data: {roll:b_number},
//			  success: function(data){
//				$("#branch_dispatch_no").val(data);
//			  }
//		  });
//	  });
