...
<div class="page-content">
 ...
 <span style="color: #184d88;">Main </span> |<span style="font-size: 14px; font-weight: 300;"> Due Letters</span></div>
...
$select = "SELECT * FROM main_letter WHERE due_date = '$date' and status = 'Pending'";
...
$datab = mysqli_fetch_array($runb);
			...
			?>			
					...
					<td><?php echo $data['Branch_Date'];?></td>
