...
if($u_type == "branch"){
$select = "SELECT * FROM b_letter WHERE status = 'Pending' and branch_name = '$branch_name'";
$run = mysqli_query($conn,$select);	
}else{		
$select = "SELECT * FROM b_letter WHERE status = 'Pending'";
$run = mysqli_query($conn,$select);			
}
...
<div class="dropdown dropdown-status classDropup ">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="deleteb_letter.php?id=<?php  echo $data['id'];?>" id="not_suspend">Delete Letter</a>
					<a class="dropdown-item" href="updateb_letter.php?id=<?php  echo $data['id'];?>" id="not_suspend">Edit Letter</a>
					<a class="dropdown-item" href="otherb_letter.php?id=<?php  echo $data['id'];?>" id="not_suspend">Mark As Complete</a>
					<a class="dropdown-item" href="#" id="not_suspend">Dispatch</a>
				</div></div>
