...
$id = $_GET['id'];
	...
	$selectb = "SELECT * FROM b_letter WHERE id = '$id'";
...
$insert = "UPDATE `b_letter` SET `branch_name`= '$b_name',`dispatch_date`= '$dispatch_date',`dispatch_time`= '$dispatch_time',`marked_to`='$marked_t', `other_mark`= '$mark_other',`branch_dispatch`= '$branch_dispatch',`officer_name`= '$officer_name',`due_date`= '$due_date',`status`= '$current_status',`remarks`= '$remarks' WHERE id = '$id'";
...
<form id="form-signin_v1" name="form-signin_v1"  method="post">
				...
				<div class="row" style="padding: 0px 20px;">
					<div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" readonly name="dispatch_from" value="<?php echo $b_name;?>" id="b_name" placeholder="Enter Branch Name">
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" id="p_number_title" for="exampleInputPassword1">Dispatch Date<span style="color: red;">*</span></label>
							<input type="date"  class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Enter Dispatch Date"  name="dispatch_date" value="<?php echo $datab['dispatch_date']?>" id="dispatch_date"><br>
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" id="p_number_title" for="exampleInputPassword1">Dispatch Time<span style="color: red;">*</span></label>
							<input type="time"  class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Enter Dispatch Date"  name="dispatch_time" value="<?php echo $datab['dispatch_time'];?>" id="dispatch_time"><br>
						</fieldset>
					</div>
	       ...
	       <div class="row" style="padding: 0px 20px;">
			   ...
			   <?php
			   $mark = $datab['marked_to'];
			   
			   if($mark != 'Other'){
			   
			   $selectd = "SELECT * FROM distric Where id = '$mark'";
			   ...
			   ?>
					...
					<div class="col-lg-4">
						<fieldset class="form-group">
							...
							<select class="form-control select2" id="marked_to" name="marked_to" required="true">
							<option selected value="<?php echo $val ;?>"><?php echo $name;?></option>
							<?php
			   ...
			   <div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text"  class="form-control" value="<?php echo $datab['branch_dispatch'];?>" data-validation="[NOTEMPTY]" data-validation-message="Enter Branch Dispatch No"  name="branch_dispatch" id="branch_dispatch"><br>
						</fieldset>
					</div>
					<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" id="p_number_title" for="exampleInputPassword1">Officer Name</label>
							<input type="text"  class="form-control" value="<?php echo $datab['officer_name']; ?>" placeholder="Officer Name"  name="officer_name" id="officer_name"><br>
						</fieldset>
					</div>
				</div><!--.row-->
		...
		<div class="row" style="padding: 0px 20px;">
					<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="date" class="form-control" <?php echo $datab['due_date'];?> name="due_date" id="due_date" placeholder="Full Name">
						</fieldset>
					</div>
	       ...
	       <div class="row" style="padding: 0px 20px;">
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<textarea class="form-control" name="remarks" data-validation="[NOTEMPTY]" data-validation-message="Enter Remarks" rows="3"><?php echo $datab['remarks'];?></textarea>
						</fieldset>
					</div>
				</div><!--.row-->
