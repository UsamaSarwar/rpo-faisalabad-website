...
$selectml = "SELECT * FROM main_letter WHERE id = '$main_id'";
$runml = mysqli_query($conn,$selectml);
$dataml = mysqli_fetch_array($runml);
				
$received = $dataml['received_from'];		
				...
				<div class="row" style="padding: 0px 20px;">
					...
					<div class="col-lg-3">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" readonly name="dairy_number" value="<?php echo $dataml['dairy_number'];?>" data-validation="[NOTEMPTY]" data-validation-message="Enter Dairy Number" id="dairy_number" placeholder="Dairy Number">
						</fieldset>
					</div>
					...
					<div class="col-lg-3">
						<fieldset class="form-group">
							...
							<input type="date"  class="form-control" value="<?php echo $dataml['received_date'];?>" readonly data-validation="[NOTEMPTY]" data-validation-message="Select Received Date"  name="received_date" id="received_date"><br>
						</fieldset>
					</div>
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" id="received_time_title" for="exampleInputPassword1">Time</label>
							<input type="time"  class="form-control" value="<?php echo $dataml['received_time'];?>" readonly  data-validation="[NOTEMPTY]" data-validation-message="Select Received Time" name="received_time" id="received_time"><br>
						</fieldset>
					</div>
				</div>				
	       <div class="row" style="padding: 0px 20px;">
			   ...
			   <div class="col-lg-3">
						<fieldset class="form-group">
							...
							<input type="text"  class="form-control" readonly placeholder="Dispatch No." value="<?php echo $dataml['dispatch_no'];?>" data-validation="[NOTEMPTY]" data-validation-message="Enter Dispatch No."  name="dispatch_no" id="dispatch_no"><br>
						</fieldset>
					</div>
					<div class="col-lg-3">
						
						<fieldset class="form-group">
							<label class="form-label" for="exampleInput">Source of Diary <span style="color: red;">*</span></label>
							<input type="text" class="form-control" readonly name="diary_source" value="<?php echo $dataml['diary_source'];?>" data-validation="[NOTEMPTY]" data-validation-message="Enter Dairy Source" id="diary_source" placeholder="Dairy Source">
						</fieldset>
					</div>
	       ...
	       <div class="row" style="padding: 0px 20px;">
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<textarea class="form-control" name="remarks"  data-validation="[NOTEMPTY]" data-validation-message="Enter Remarks" rows="3"><?php echo $dataml['remarks'];?>
							</textarea>
						</fieldset>
					</div>
				</div><!--.row-->
