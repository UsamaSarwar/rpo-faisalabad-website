	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<h5 class="m-t-lg with-border" style="margin-bottom: 20px; color: #184d88;"><i class="font-icon"> <img src="img/Icons/diary.svg" style="height: 20px; width: 20px; " alt=""></i> Main Dispatch <span style="font-size: 15px; color: #545454;">(All fields marked with <span style="color: red;">*</span> are required)</span></h5>
...
$insert = "INSERT INTO `main_dispatch`(`received_from`, `dairy_number`, `received_date`, `time`, `dispatch_no`, `dispatch_date`, `dispatch_from`, `file`, `remarks`) VALUES ('$received_from','$dairy_number','$received_date','$time','$dispatch_no','$dispatch_date','$dispatch_from','$filename','$remarks')";
...
if(!$run){
	...
	$insertl = "INSERT INTO `main_letter`(`dairy_number`, `dispatch_no`, `received_date`, `received_time`, `received_from`, `dispatch_date`, `status`, `file`, `remarks`) VALUES ('$dairy_number','$dispatch_no','$received_date','$time','$received_from','$dispatch_date','$status','$filename','$remarks')";
	$runl = mysqli_query($conn,$insertl);
	if(!$runl){
				...
				<div class="row" style="padding: 0px 20px;">
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInput">Branch Received From<span style="color: red;">*</span></label>
					...
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" id="dispatch_time_title" for="exampleInputPassword1">Time</label>
							<input type="time"  class="form-control" value="<?php echo date("H:i:s");?>"  data-validation="[NOTEMPTY]" data-validation-message="Select Received Time" name="time" id="dispatch_time"><br>
						</fieldset>
					</div>
				</div>				
	       <div class="row" style="padding: 0px 20px;">
	       ...
	       <div class="row" style="padding: 0px 20px;">
				...
				<div class="row" style="padding: 0px 20px;">
					<div class="col-md-12 col-sm-12 d-flex justify-content-end" style="margin-top: 10px;">
						...
						<input type="button" value="Save" id="sub" style="padding: 10px 35px;" class="btn btn-rounded btn-inline btn-primary">
					</div>
				</div><!--.row-->
</form>
