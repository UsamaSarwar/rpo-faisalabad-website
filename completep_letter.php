...
if($_POST){
	...
	$fir_position = $_POST['fir_position'];
	$final_remarke = $_POST['final_remarke'];
	$status = "Completed";

	

$insert = "UPDATE `progress` SET `letter_number`='$letter_number',`letter_date`='$letter_date',`fir_position`='$fir_position',`final_remarke`='$final_remarke',`status`='$status' WHERE  id = '$id'";
...
<form id="form-signin_v1" name="form-signin_v1"  method="post">
					...
					<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" name="fir_number" value="<?php echo $datap['fir_number'];?>" id="b_name" readonly placeholder="Enter Branch Name">
						</fieldset>
					</div>
					<div class="col-lg-6">
						<fieldset class="form-group">
							<label class="form-label" id="p_number_title" for="exampleInputPassword1">Received Letter Number<span style="color: red;">*</span></label>
							<input type="text"  class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Enter Letter Number"  name="letter_number"  id="dispatch_date"><br>
						</fieldset>
					</div>
		...
		<div class="row" style="padding: 0px 20px;">
			    	...
			    	<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="date"  class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Select Date" value="<?php echo date("Y-m-d");?>" placeholder="Enter Crime" name="letter_date"  id="dispatch_time"><br>
						</fieldset>
					</div>
			   <div class="col-lg-6">
						<fieldset class="form-group">
							<label class="form-label" id="course_title" for="exampleemail">FIR Position <span style="color: red;">*</span></label>
							<select class="form-control select2" id="marked_to" name="fir_position" required="true">
							<option value="Complete Challan">Complete Challan</option>
							<option value="Incomplete Challan"> Incomplete Challan</option>
							<option value="Challan U/S 512 Cr.Pc">Challan U/S 512 Cr.Pc</option>
							<option value="Untraced">Untraced</option>
							<option value="Canceled">Canceleds</option>
	       ...
	       <div class="row" style="padding: 0px 20px;">
					<div class="col-lg-12">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInput">Final Remarks<span style="color: red;">*</span></label>
							<textarea class="form-control" name="final_remarke" data-validation="[NOTEMPTY]" data-validation-message="Enter Remarks" rows="3"></textarea>
						</fieldset>
					</div>
				</div><!--.row-->
