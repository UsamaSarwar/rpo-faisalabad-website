...
<div class="page-content">
 ...
 <span style="color: #184d88;">Khuli Kachehri </span> |<span style="font-size: 14px; font-weight: 300;"> Due Letters</span></div>
...
$select = "SELECT * FROM kachehri WHERE status = 'Pending'";
