...
<div class="page-content">
 ...
 <span style="color: #184d88;">Branches </span> |<span style="font-size: 14px; font-weight: 300;"> Due Letters</span></div>
...
$select = "SELECT * FROM branch_mark WHERE due_date = '$date' and current_status = 'Pending'";
$run = mysqli_query($conn,$select);
while($data = mysqli_fetch_array($run)):

$received = $data['dispatch_from'];
$mark = $data['marked_to'];
			
$selectr = "SELECT * FROM branch Where branch_name = '$received'";
$runr = mysqli_query($conn,$selectr);
$datar = mysqli_fetch_array($runr);

$selectb = "SELECT * FROM distric Where id = '$mark'";
