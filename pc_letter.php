...
<?php
		$counter = 0;
	$selectp = "SELECT * FROM progress WHERE status = 'Completed'";
	$runp = mysqli_query($conn,$selectp);
	while($datap = mysqli_fetch_array($runp)):
			?>
						<tr>
                    <td><?php echo ++$counter; ?></td>
                    <td><?php echo $datap['district']; ?></td>
                    ...
                    <td><?php echo $datap['letter_number']; ?></td>
                    <td><?php echo $datap['letter_date']; ?></td>
                    <td><?php echo $datap['final_remarke']; ?></td>
                    <td><?php echo $datap['fir_position']; ?></td>
...
<div class="dropdown dropdown-status classDropup ">
				...
				<div class="dropdown-menu">
					...
					<a class="dropdown-item" href="#" id="not_suspend">Completed</a>
