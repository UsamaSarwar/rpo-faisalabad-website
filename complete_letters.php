...
<div class="page-content">
 ...
 <span style="color: #184d88;">Branches </span> |<span style="font-size: 14px; font-weight: 300;">Completed Letters</span></div>
...
$select = "SELECT * FROM main_letter WHERE status = 'Completed'";
...
$datab = mysqli_fetch_array($runb);
			...
			?>			
					...
					<td><?php echo $data['final_dispatch_no'];?></td>
                    <td><?php echo $data['final_dispatch_date'];?></td>
...
<div class="dropdown dropdown-status classDropup ">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="#" id="not_suspend">Mark to Other</a>
					<a class="dropdown-item" href="#" id="not_suspend">Edit</a>
					<a class="dropdown-item" href="#" id="not_suspend">Delete</a>
				</div></div>
